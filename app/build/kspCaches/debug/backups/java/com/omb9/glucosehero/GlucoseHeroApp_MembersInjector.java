...
public final class GlucoseHeroApp_MembersInjector implements MembersInjector<GlucoseHeroApp> {
  ...
  private final Provider<PostMealReminderNotifier> postMealReminderNotifierProvider;
  ...
  private GlucoseHeroApp_MembersInjector(Provider<HiltWorkerFactory> workerFactoryProvider,
    ...
    this.postMealReminderNotifierProvider = postMealReminderNotifierProvider;
  }
  ...
  public void injectMembers(GlucoseHeroApp instance) {
    ...
    injectPostMealReminderNotifier(instance, postMealReminderNotifierProvider.get());
  }
  ...
  public static MembersInjector<GlucoseHeroApp> create(
      ...
      Provider<InsightNotifier> insightNotifierProvider,
      Provider<PostMealReminderNotifier> postMealReminderNotifierProvider) {
    return new GlucoseHeroApp_MembersInjector(workerFactoryProvider, insightNotifierProvider, postMealReminderNotifierProvider);
  }
  ...
  @InjectedFieldSignature("com.omb9.glucosehero.GlucoseHeroApp.postMealReminderNotifier")
  public static void injectPostMealReminderNotifier(GlucoseHeroApp instance,
      PostMealReminderNotifier postMealReminderNotifier) {
    instance.postMealReminderNotifier = postMealReminderNotifier;
  }
}
