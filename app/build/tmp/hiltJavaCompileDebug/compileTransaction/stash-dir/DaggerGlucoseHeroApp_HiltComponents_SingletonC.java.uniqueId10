...
import com.omb9.glucosehero.di.DatabaseModule_ProvideSupplyDaoFactory;
...
import com.omb9.glucosehero.work.PostMealReminderWorker;
import com.omb9.glucosehero.work.PostMealReminderWorker_AssistedFactory;
...
public final class DaggerGlucoseHeroApp_HiltComponents_SingletonC {
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new EntryDetailViewModel(viewModelCImpl.savedStateHandle, singletonCImpl.entryRepositoryImplProvider.get(), singletonCImpl.settingsRepositoryImplProvider.get(), singletonCImpl.reminderSchedulerProvider.get(), singletonCImpl.widgetRefresherProvider.get());

          case 2: // com.omb9.glucosehero.ui.log.LogViewModel
          return (T) new LogViewModel(singletonCImpl.entryRepositoryImplProvider.get(), singletonCImpl.settingsRepositoryImplProvider.get(), singletonCImpl.heroAiPrefillCoordinatorProvider.get(), singletonCImpl.reminderSchedulerProvider.get(), singletonCImpl.widgetRefresherProvider.get());

          case 3: // com.omb9.glucosehero.ui.settings.SettingsViewModel
          return (T) new SettingsViewModel(singletonCImpl.settingsRepositoryImplProvider.get(), singletonCImpl.billingRepositoryProvider.get());

          case 4: // com.omb9.glucosehero.ui.stats.StatsViewModel
          return (T) new StatsViewModel(singletonCImpl.entryRepositoryImplProvider.get(), singletonCImpl.settingsRepositoryImplProvider.get(), singletonCImpl.supplyRepositoryImplProvider.get(), singletonCImpl.exportManagerProvider.get());
  ...
  private static final class SingletonCImpl extends GlucoseHeroApp_HiltComponents.SingletonC {
    ...
    Provider<PostMealReminderNotifier> postMealReminderNotifierProvider;

    Provider<PostMealReminderWorker_AssistedFactory> postMealReminderWorker_AssistedFactoryProvider;
    ...
    Provider<SupplyRepositoryImpl> supplyRepositoryImplProvider;
    ...
    Map mapOfStringAndProviderOfWorkerAssistedFactoryOfListenableWorkerBuilder() {
      ...
      mapBuilder.put("com.omb9.glucosehero.work.PendingQueryWorker", ((Provider) (pendingQueryWorker_AssistedFactoryProvider)));
      mapBuilder.put("com.omb9.glucosehero.work.PostMealReminderWorker", ((Provider) (postMealReminderWorker_AssistedFactoryProvider)));
      return mapBuilder.build();
    }
    ...
    Map<String, javax.inject.Provider<WorkerAssistedFactory<? extends ListenableWorker>>> mapOfStringAndProviderOfWorkerAssistedFactoryOfListenableWorker(
      ...
      return mapOfStringAndProviderOfWorkerAssistedFactoryOfListenableWorkerBuilder();
    }
    ...
    SupplyDao supplyDao() {
      return DatabaseModule_ProvideSupplyDaoFactory.provideSupplyDao(provideDatabaseProvider.get());
    }
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.postMealReminderNotifierProvider = DoubleCheck.provider(new SwitchingProvider<PostMealReminderNotifier>(singletonCImpl, 14));
      this.postMealReminderWorker_AssistedFactoryProvider = SingleCheck.provider(new SwitchingProvider<PostMealReminderWorker_AssistedFactory>(singletonCImpl, 13));
      this.connectivityObserverProvider = DoubleCheck.provider(new SwitchingProvider<ConnectivityObserver>(singletonCImpl, 15));
      this.heroAiPrefillCoordinatorProvider = DoubleCheck.provider(new SwitchingProvider<HeroAiPrefillCoordinator>(singletonCImpl, 16));
      this.entryRepositoryImplProvider = DoubleCheck.provider(new SwitchingProvider<EntryRepositoryImpl>(singletonCImpl, 17));
      this.reminderSchedulerProvider = DoubleCheck.provider(new SwitchingProvider<ReminderScheduler>(singletonCImpl, 18));
      this.widgetRefresherProvider = DoubleCheck.provider(new SwitchingProvider<WidgetRefresher>(singletonCImpl, 19));
      this.billingRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<BillingRepository>(singletonCImpl, 20));
      this.supplyRepositoryImplProvider = DoubleCheck.provider(new SwitchingProvider<SupplyRepositoryImpl>(singletonCImpl, 21));
      this.exportManagerProvider = DoubleCheck.provider(new SwitchingProvider<ExportManager>(singletonCImpl, 22));
    }
    ...
    private GlucoseHeroApp injectGlucoseHeroApp2(GlucoseHeroApp instance) {
      ...
      GlucoseHeroApp_MembersInjector.injectPostMealReminderNotifier(instance, postMealReminderNotifierProvider.get());
      return instance;
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          case 13: // com.omb9.glucosehero.work.PostMealReminderWorker_AssistedFactory
          return (T) new PostMealReminderWorker_AssistedFactory() {
            @Override
            public PostMealReminderWorker create(Context appContext2,
                WorkerParameters workerParams2) {
              return new PostMealReminderWorker(appContext2, workerParams2, singletonCImpl.settingsRepositoryImplProvider.get(), singletonCImpl.postMealReminderNotifierProvider.get());
            }
          };

          case 14: // com.omb9.glucosehero.work.PostMealReminderNotifier
          return (T) new PostMealReminderNotifier(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));

          case 15: // com.omb9.glucosehero.work.ConnectivityObserver
          ...
          case 16: // com.omb9.glucosehero.ui.log.HeroAiPrefillCoordinator
          return (T) new HeroAiPrefillCoordinator();

          case 17: // com.omb9.glucosehero.data.repository.EntryRepositoryImpl
          return (T) new EntryRepositoryImpl(singletonCImpl.entryDao());

          case 18: // com.omb9.glucosehero.work.ReminderScheduler
          ...
          case 19: // com.omb9.glucosehero.ui.glance.WidgetRefresher
          return (T) new WidgetRefresher(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));

          case 20: // com.omb9.glucosehero.data.billing.BillingRepository
          return (T) new BillingRepository(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));

          case 21: // com.omb9.glucosehero.data.repository.SupplyRepositoryImpl
          return (T) new SupplyRepositoryImpl(singletonCImpl.supplyDao());

          case 22: // com.omb9.glucosehero.data.export.ExportManager
          return (T) new ExportManager(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.entryRepositoryImplProvider.get(), singletonCImpl.settingsRepositoryImplProvider.get());
