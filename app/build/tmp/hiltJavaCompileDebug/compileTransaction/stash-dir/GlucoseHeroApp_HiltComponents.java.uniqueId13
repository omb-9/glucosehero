...
import com.omb9.glucosehero.di.DatabaseModule;
import com.omb9.glucosehero.di.NetworkModule;
import com.omb9.glucosehero.di.RepositoryModule;
...
import com.omb9.glucosehero.ui.glance.GlucoseHeroWidgetEntryPoint;
...
import com.omb9.glucosehero.work.PendingQueryWorker_HiltModule;
import com.omb9.glucosehero.work.PostMealReminderWorker_HiltModule;
import dagger.Binds;
...
public final class GlucoseHeroApp_HiltComponents {
  private GlucoseHeroApp_HiltComponents() {
  }
  ...
  @Component(
      modules = {
          ...
          NetworkModule.class,
          PendingQueryWorker_HiltModule.class,
          PostMealReminderWorker_HiltModule.class,
          RepositoryModule.class
      }
  )
  @Singleton
  @jakarta.inject.Singleton
  public abstract static class SingletonC implements GlucoseHeroApp_GeneratedInjector,
      GlucoseHeroWidgetEntryPoint,
